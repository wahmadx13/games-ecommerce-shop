export const gameDetailsClientClassNames = {
  container:
    "py-10 max-w-xs md:max-w-3xl mx-auto flex flex-col items-center justify-center",
  carousel: "relative w-full h-64 mb-4",
  previousButton:
    "absolute top-1/2 left-2 transform -translate-y-1/2 px-4 py-2 bg-grey-500 text-white rounded-l",
  nextButton:
  ...
  addToCardButton: "px-4 py-2 mt-4 bg-blue-500 text-white rounded",
...
export const gameDetailServerClassNames = {
  descriptionClass: "text-lg text-gray-300 mb-2",
  nameClass: "text-4xl pt-5 text-gray-300 font-bold mb-2",
  priceClass: "text-2xl text-primary font-bold",
};
